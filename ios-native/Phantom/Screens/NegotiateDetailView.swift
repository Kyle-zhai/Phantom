            ...
            VStack(alignment: .leading, spacing: 0) {
                ...
                if offer.successRateEstimated {
                    HStack(alignment: .top, spacing: 10) {
                        ...
                        Text("Estimated from public reports (Reddit r/personalfinance, Consumer Reports, Rocket Money transparency data). Phantom will replace this with real outcomes once 50+ users have tried this vendor.")
                            .font(AppFont.small).foregroundStyle(Palette.mute)
                    }
                    .padding(12)
