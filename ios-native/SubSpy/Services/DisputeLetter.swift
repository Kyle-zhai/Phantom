...
enum DisputeReason: String, CaseIterable, Identifiable {
    ...
    /// These are population averages, not SubSpy outcomes.
    var successRate: Int {
        switch self {
...
enum DisputeLetter {
    static func generate(for sub: Subscription, form: DisputeForm) -> String {
        ...
        — Letter generated by SubSpy on behalf of \(form.fullName). \
        SubSpy does not file disputes on the consumer's behalf without explicit per-letter authorization.
        """
    }
}
