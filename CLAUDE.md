...
| Negotiate | Per-vendor retention scripts (64 playbooks, 69 ids with billing-descriptor aliases); "cancel instead" jumps to the cancel page |
...
Services/
  ...
  Negotiation.swift         # 64 vendor retention scripts + descriptor aliases + researched no-offer list
